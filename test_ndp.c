...
int main(int argc, char** argv) {
	uint16_t dest_ipaddr[IPV6_ADDR_LEN] = { 0xfe80, 0x0, 0x0, 0x0, 0xa00, 0x27ff, 0xfe5c, 0x2c17, };
	uint16_t dest_ipaddr2[IPV6_ADDR_LEN] = { 0xfe80, 0x0, 0x0, 0x0, 0xbd41, 0x2638, 0x69a0, 0x87d8 };
